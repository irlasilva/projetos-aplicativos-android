package br.edu.ifrs.appexemplo2.model;
...
public class Pessoa {
    ...
    public static List<Pessoa> inicializaLista(){
        ...
        pessoas.add(    new Pessoa("Maria", "20/11/2001", "Rua Vicente Monteggia xxxxxxxxxxxxxxxxxx yyyyyyyyyyyyyyyyyyyyy uuuuuuuuuuuuuuuuuuuuuuu, 20"));
