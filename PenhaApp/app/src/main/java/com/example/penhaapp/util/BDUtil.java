package com.example.penhaapp.util;
...
public class BDUtil extends SQLiteOpenHelper {
    ...
    private static final String BASE_DE_DADOS = "PENHA";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        criarTabela.append(" CREATE TABLE OCORRENCIA (");
        criarTabela.append(" _ID   INTEGER PRIMARY KEY AUTOINCREMENT, ");
        criarTabela.append(" TIPO  TEXT    NOT NULL,");
